...
export const SOURCE_CATEGORIES = [
  ...
  },
  {
    ...
    types: [
      ...
      {
        id: 'gtfs',
        label: 'Tricity transit',
        icon: 'TR',
        prefix: '/gtfs',
        kind: 'poll',
        hint: 'ZTM Gdańsk + ZKM Gdynia live GPS (Otwarty Gdańsk). No key.',
        hero: 'count',
        heroUnit: 'Vehicles',
        defaults: { intervalSec: 10 },
        fields: [
          { id: 'count', label: 'Vehicles' },
          { id: 'moving', label: 'Moving' },
          { id: 'speed', label: 'Max km/h' },
          { id: 'late', label: 'Late >1 min' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    types: [
      ...
      },
      {
        ...
        prefix: '/gdacs',
        kind: 'poll',
        hint: 'Global disaster alerts (last ~4 days). No key.',
        hero: 'count',
        heroUnit: 'Events',
        defaults: { intervalSec: 300 },
        fields: [
  ...
  },
  {
    ...
    types: [
      ...
      },
      {
        ...
        prefix: '/inat',
        kind: 'poll',
        hint: 'Nearby iNaturalist observations. No key. Stay polite on refresh.',
        hero: 'today',
        heroUnit: 'Today',
        defaults: { intervalSec: 120, lat: 54.52, lon: 18.53, radiusKm: 25 },
        fields: [
          { id: 'today', label: 'Today' },
          { id: 'total', label: 'All nearby' },
        ],
      },
      {
        id: 'ais',
        ...
        stream: true,
        needsKey: true,
        hint: 'AISStream bounding box around a point (Gdynia harbour default). Free key, keep it private.',
        hero: 'count',
        heroUnit: 'Ships',
        defaults: { intervalSec: 2, lat: 54.534, lon: 18.547, radiusKm: 12, apiKey: '', autoStart: false },
        fields: [
          { id: 'count', label: 'Ships' },
          { id: 'moving', label: 'Moving' },
          { id: 'speed', label: 'Max kn' },
        ],
      },
      {
        id: 'hydro',
        ...
        prefix: '/hydro',
        kind: 'poll',
        hint: 'Polish river gauge (Gdańska Głowa / Wisła default). Not Baltic sea level. No key.',
        hero: 'level',
        heroUnit: 'cm',
        defaults: { intervalSec: 120, stationId: 154180220 },
        fields: [
          { id: 'level', label: 'Water cm' },
          { id: 'warn', label: 'Above warning' },
          { id: 'alarm', label: 'Above alarm' },
        ],
      },
      {
        id: 'tides',
    ...
    types: [
      {
        ...
        kind: 'poll',
        stream: true,
        hint: 'Hacker News live maxitem (Firebase). New items per window. No key.',
        hero: 'delta',
        heroUnit: 'New items',
      ...
      },
      {
        ...
        kind: 'poll',
        stream: true,
        hint: 'Bluesky Jetstream post firehose. No key. Click Start — it is a live WebSocket.',
        hero: 'rate',
        heroUnit: 'Posts / sec',
        defaults: { intervalSec: 2, autoStart: false },
        fields: [
          { id: 'rate', label: 'Posts / sec' },
          { id: 'posts', label: 'Posts in window' },
          { id: 'chars', label: 'Avg chars' },
        ],
      },
      {
        id: 'masto',
        ...
        prefix: '/masto',
        kind: 'poll',
        hint: 'Public timeline pulse on an instance that still allows unauthenticated reads (not mastodon.social). No key.',
        hero: 'delta',
        heroUnit: 'New posts',
        defaults: { intervalSec: 15, host: 'fosstodon.org' },
        fields: [
          { id: 'delta', label: 'New posts' },
          { id: 'chars', label: 'Avg chars' },
        ],
      },
      {
        ...
        kind: 'poll',
        stream: true,
        hint: 'Wikimedia EventStreams recent changes. Optional wiki filter like enwiki. Click Start.',
        hero: 'rate',
        heroUnit: 'Edits / sec',
        defaults: { intervalSec: 2, wiki: '', autoStart: false },
        fields: [
          { id: 'rate', label: 'Edits / sec' },
          { id: 'edits', label: 'Edits in window' },
          { id: 'bots', label: 'Bot edits' },
        ],
      },
      {
        id: 'wiki',
  ...
  },
  {
    ...
    types: [
      ...
      },
      {
        ...
        prefix: '/sat',
        kind: 'poll',
        hint: 'Celestrak GP + local SGP4 look angles from your point. Default ISS. No key. Cache ≥2h.',
        hero: 'el',
        heroUnit: 'Elevation °',
        defaults: { intervalSec: 2, lat: 54.52, lon: 18.53, norad: 25544 },
        fields: [
          { id: 'az', label: 'Azimuth °' },
          { id: 'el', label: 'Elevation °' },
          { id: 'range', label: 'Range km' },
          { id: 'visible', label: 'Above horizon' },
        ],
      },
      {
        id: 'neo',
  ...
  },
  {
    ...
    types: [
      ...
      },
      {
        ...
        kind: 'poll',
        needsKey: true,
        hint: 'Now-playing via scrobbles. API key + Last.fm user.',
        hero: 'playing',
        heroUnit: 'Playing',
        defaults: { intervalSec: 15, user: '', apiKey: '' },
        fields: [
          { id: 'playing', label: 'Now playing' },
          { id: 'hash', label: 'Track hash 0–1' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    types: [
      ...
      },
      {
        ...
        prefix: '/holiday',
        kind: 'poll',
        hint: 'Days until the next Polish public holiday (Nager.Date). No key.',
        hero: 'days',
        heroUnit: 'Days',
        defaults: { intervalSec: 3600 },
        fields: [
          { id: 'days', label: 'Days until' },
          { id: 'today', label: 'Is today' },
        ],
      },
    ],
  },
